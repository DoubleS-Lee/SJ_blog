        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4">
              <Link href="/admin/analytics" className="text-sm text-gray-500 hover:text-black transition-colors">
                분석
              </Link>
              ...
              <Link href="/life-graph" className="text-sm text-gray-500 hover:text-black transition-colors">
                사주 생애 그래프
              </Link>
              <Link href="/interpretation" className="text-sm text-gray-500 hover:text-black transition-colors">
                사주 해석
              </Link>
